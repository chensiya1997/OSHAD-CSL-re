...
class ChebGraphConv(nn.Module):
    ...
    def forward(self, x):
        ...
        x = torch.permute(x, (0, 2, 3, 1))  #调整矩阵形状
...
class CNN(nn.Module):
    def __init__(self,feature_size,out_channels,output_size):
        ...
        self.conv1d_1=nn.Conv2d(feature_size, out_channels[0], kernel_size=3)
        self.conv1d_2=nn.Conv2d(out_channels[0],out_channels[1],kernel_size=3)
        self.conv1d_3 = nn.Conv2d(out_channels[1], out_channels[2], kernel_size=3)
...
class OutputBlock(nn.Module):
    ...
    def __init__(self, Ko, last_block_channel, channels, end_channel, n_vertex, act_func, bias, droprate):
        ...
        self.tmp_conv1 = TemporalConvLayer(10, last_block_channel, channels[0], n_vertex, act_func)
